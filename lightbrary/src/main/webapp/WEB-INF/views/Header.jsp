...
<header>
	...
	<div id='headerTop'>
		...
		<ul id='headerOptions' class='fs0'>
			...
			<li id='hBasket'>
				<a href="#none">
					<img alt="바구니" src="resources/img/icon-cart.png">
				</a>
			</li>
			<li>
				<a href="#none" id='myPageClick' class='hOptionsText'>
					<span>박상아</span> 님
					<img alt="화살표" src="resources/img/arrow.png" style="vertical-align: 2px">
				</a>
					...
					<ul>
						<li>
							<a href="#none" class='fs0'>
								<img alt="내 정보" src="resources/img/icon-user.png">
								<span>내 정보</span>
							</a>
						</li>
						<li>
							<a href="#none" class='fs0'>
								<img alt="내 정보" src="resources/img/icon-single-book.png">
								<span>나의 대출 기록</span>
							</a>
						</li>
						<li>
							<a href="#none" class='fs0'>
								<img alt="내 정보" src="resources/img/icon-clock.png">
								<span>나의 예약 현황</span>
							</a>
						</li>
					</ul>
